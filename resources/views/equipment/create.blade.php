...
<div class="row g-3">
    <div class="col-md-9">
        <div class="card card-primary card-outline shadow-sm" style="border-radius: 12px;">
            <div class="card-header bg-white">
                <h3 class="card-title fw-bold"><i class="fas fa-plus-circle me-2 text-primary"></i>Thông tin thiết bị</h3>
            </div>
            <form action="{{ route('equipment.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div id="specs-section" class="mt-4 pt-3 border-top" style="display: none;">
                        <h5 class="text-primary fw-bold mb-3"><i class="fas fa-microchip me-2"></i>Thông số kỹ thuật</h5>
                ...
                <div class="card-footer bg-white border-top d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary px-6 shadow-sm fw-bold">
    ...
    <div class="col-md-3">
        <div class="card card-info card-outline shadow-sm">
            <div class="card-header"><h3 class="card-title fw-bold"><i class="fas fa-info-circle me-2"></i>Hướng dẫn</h3></div>
