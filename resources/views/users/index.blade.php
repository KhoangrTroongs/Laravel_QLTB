        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($user->status == 1)
                            <span class="badge badge-success" style="border-radius: 8px; padding: 0.4rem 0.8rem;">
                                <i class="fas fa-check-circle mr-1"></i>Đang làm việc
                            </span>
                        @else
                            <span class="badge badge-secondary" style="border-radius: 8px; padding: 0.4rem 0.8rem;">
                                <i class="fas fa-user-slash mr-1"></i>Đã nghỉ việc
                            </span>
                        @endif
                    </td>
